...
namespace SFMasterYi
{
    class SFUpdater
    {
        ...
        private static void bgw_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            {
                Game.PrintChat("<font color='#33FFFF'> .: SFTEMPLATE: Updating ...");
                Game.PrintChat("<font color='#33FFFF'> .: SFTEMPLATE: Auto updater by trelli.");

                if (myUpdater.Update())
                {
                    Game.PrintChat("<font color='#33FFFF'> .: SFTEMPLATE: Update complete, reload please.");
                }
            }
            else
            {
